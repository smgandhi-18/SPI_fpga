...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net processing_system7_0_SPI0_MISO_O [get_bd_pins processing_system7_0/SPI0_MISO_O] [get_bd_pins processing_system7_0/SPI1_MISO_I]
  connect_bd_net -net processing_system7_0_SPI0_MOSI_O [get_bd_pins processing_system7_0/SPI0_MOSI_O] [get_bd_pins processing_system7_0/SPI1_MOSI_I]
  connect_bd_net -net processing_system7_0_SPI0_SCLK_O [get_bd_pins processing_system7_0/SPI0_SCLK_O] [get_bd_pins processing_system7_0/SPI1_SCLK_I]
  connect_bd_net -net processing_system7_0_SPI0_SS_O [get_bd_pins processing_system7_0/SPI0_SS_O] [get_bd_pins processing_system7_0/SPI1_SS_I]
  connect_bd_net -net processing_system7_0_SPI1_MISO_O [get_bd_pins processing_system7_0/SPI0_MISO_I] [get_bd_pins processing_system7_0/SPI1_MISO_O]
  connect_bd_net -net processing_system7_0_SPI1_MOSI_O [get_bd_pins processing_system7_0/SPI0_MOSI_I] [get_bd_pins processing_system7_0/SPI1_MOSI_O]
  connect_bd_net -net processing_system7_0_SPI1_SCLK_O [get_bd_pins processing_system7_0/SPI0_SCLK_I] [get_bd_pins processing_system7_0/SPI1_SCLK_O]
  connect_bd_net -net processing_system7_0_SPI1_SS_O [get_bd_pins processing_system7_0/SPI0_SS_I] [get_bd_pins processing_system7_0/SPI1_SS_O]
